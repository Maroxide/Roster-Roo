...
$query = mysql_query("select * from rosters where date='$date' AND time='$time' AND userid = 'userid'", $conn);
$rows = mysql_num_rows($query);
if ($rows == 1) {
  $errors[] = 'That entry already exists, try another date and time';
}else
{
...
<div id = "alert_placeholder"></div>
    <div class="container">
      <div class="jumbotron">
        <h1>Roster Date Entry successful!</h1>      
         <br>
         </div>
    </div>
