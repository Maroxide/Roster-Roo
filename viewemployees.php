...
<html>
  <head>
    <title>Roster-Roo | <?php echo $_SESSION['cname']; ?> Select Employee </title>
    <meta charset="utf-8">
 ...
 <li class="dropdown">
    ...
    <div class="container">
      <div class="jumbotron">
        <h1>Welcome!</h1>
         <br>
         <p>Hey <?php echo $_SESSION['fname'];?>, please select an employee who's roster you want assign.</p>
...
echo '<h3><a href = "http://rosterroo.site88.net/assignmonth.php?id='.$_SESSION["userid"].'&empid='.$empid.'"</a><u>Employee Name: </u>'.$empname.'</h3><br>Email: <i>' .$empemail. '</i><br>';
echo "</div>";
echo "</div>";
}
}
