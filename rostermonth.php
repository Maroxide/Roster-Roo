 ...
 <li class="dropdown">
    ...
    <div class="container">
      <div class="jumbotron">
        <h1>Welcome!</h1>
         <br>
         <p>Hey <?php echo $_SESSION['fname'];?>, please select a date and time that you want an employee to work at <?php echo $_SESSION['cname'];?> .</p>
...
mysql_select_db($dbname) or die("MySQL Error: " . mysql_error());
    if(!isset($_GET['by'])){
 $sql = "SELECT * FROM rosters WHERE userid = '$userid' AND month = '$month' ";
...
echo '<h3><a href= "http://rosterroo.site88.net/selectemp.php?id='.$_SESSION["userid"].'&month='. $_SESSION['month'].'&rostid='.$rostid.'"><u>Date :</u>'.$date.'</a></h3><br>Time: <i>' .$time. '</i><br>';
echo "</div>";
echo "</div>";
}
}
